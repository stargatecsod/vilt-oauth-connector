...
app.put("/instructor", protectedController.updateInstructor);
...
app.put("/folder1/folder2/api/instructor", protectedController.updateInstructor);
...
app.put("/folder1/folder2/folder3/api/instructor", protectedController.updateInstructor);
